				...
				{this.state.user && (
					<div>
						<p>
							...
							<br />
							<Link href='/logout' class='dark bold'>
								Logout
							</Link>
						</p>
						<div>
						...
						<h6>
							To request an archive of your files email me at{' '}
							<b>danielgulic@gmail.com</b>
						</h6>
						<h6>
							If you're using ShareX,{' '}
							<a href='https://i.jlz.fun/DDP79Z9.txt'>
								use our destination config
							</a>
							.
						</h6>
					</div>
